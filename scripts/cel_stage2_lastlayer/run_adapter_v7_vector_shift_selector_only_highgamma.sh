...
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-0}" python -m dialogue_kt.main train \
  ...
  --cel_selector_init_model_name cel_adapter_lastlayer_v6_vector_shift_selector_only_qwen3_1.7b \
  --model_name cel_adapter_lastlayer_v7_vector_shift_selector_only_highgamma_qwen3_1.7b \
