...
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-1}" python -m dialogue_kt.main train \
  ...
  --cel_selector_init_model_name cel_adapter_lastlayer_v12_selector_only_tinylr_nowd_qwen3_1.7b \
  --model_name cel_adapter_lastlayer_v15_predshift_selector_only_tinylr_nowd_qwen3_1.7b \
