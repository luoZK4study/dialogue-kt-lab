...
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-1}" python -m dialogue_kt.main train \
  ...
  --cel_selector_init_model_name cel_task_conditioned_lastlayer_v4_vector_shift_selector_only_tinylr_qwen3_1.7b \
  --model_name cel_task_conditioned_lastlayer_v5_vector_shift_selector_only_tinylr_nowd_qwen3_1.7b \
