...
MATHDIAL_DIALOGUE_DESC = (
    "the student is attempting to solve a math problem. You are also given this problem, "
    "its correct solution, and the incorrect solution the student initially gave."
)
