...
BEP-Adaptive-Labels 已完成；BEP-Adaptive 仍在训练中。

| 方法 | Overall AUC | Final Turn AUC | vs 1.7B baseline 75.99 | vs paper 76.71 | 备注 |
|------|:-----------:|:--------------:|:----------------------:|:--------------:|------|
| BEP-Adaptive | — | — | — | — | 训练中/待运行 |
| BEP-Adaptive-Labels | 75.93 | 75.27 | -0.06 | -0.78 | 2 epochs；未超过基线/论文 |

## 当前结论

本方法是论文思想的轻量 prompt-side adaptation，利用“证据强度/可靠性”指导 LLMKT 不要平均吸收所有历史上下文。优点是改动小、训练成本低，适合先作为第一篇论文的快速验证；若单模型不足以超过 76.71，可与 SELFELICIT 或后续 context compression 方法做 honest ensemble。
